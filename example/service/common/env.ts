/**
 * Environment variables for the `@your-org/example-service-common` package, including inherited variables.
...
export interface ExampleServiceCommonEnvSchema {
  /**
  ...
  EXAMPLE_SERVICE_HTTP_HOST: string;
  /**
...
/**
 * `process.env` casted to the `ExampleServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as ExampleServiceCommonEnvSchema;
