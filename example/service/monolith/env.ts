/**
 * Environment variables for the `@your-org/example-monolith` package, including inherited variables.
...
export interface ExampleMonolithEnvSchema {
  /**
...
/**
 * `process.env` casted to the `ExampleMonolithEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as ExampleMonolithEnvSchema;
