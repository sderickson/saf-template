/**
 * Environment variables for the `@your-org/tasktap-service-common` package, including inherited variables.
...
export interface TasktapServiceCommonEnvSchema {
  /**
  ...
  TASKTAP_SERVICE_HTTP_HOST: string;
  /**
...
/**
 * `process.env` casted to the `TasktapServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TasktapServiceCommonEnvSchema;
