/**
 * Environment variables for the `@your-org/tasktap-monolith` package, including inherited variables.
...
export interface TasktapMonolithEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TasktapMonolithEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TasktapMonolithEnvSchema;
