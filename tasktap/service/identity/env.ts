/**
 * Environment variables for the `@your-org/tasktap-identity` package, including inherited variables.
...
export interface TasktapIdentityEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TasktapIdentityEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TasktapIdentityEnvSchema;
